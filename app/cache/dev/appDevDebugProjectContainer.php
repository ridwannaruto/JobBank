...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/xampp/htdocs/symfony/JobBank/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/xampp/htdocs/symfony/JobBank/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'D:/xampp/htdocs/symfony/JobBank/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'D:/xampp/htdocs/symfony/JobBank/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'jobbank', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_f8f66d4e4b0da9c7493361e745cfaa2fff0e88c72571f2073fa2f544404d8663');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_f8f66d4e4b0da9c7493361e745cfaa2fff0e88c72571f2073fa2f544404d8663');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_f8f66d4e4b0da9c7493361e745cfaa2fff0e88c72571f2073fa2f544404d8663');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('D:\\xampp\\htdocs\\symfony\\JobBank\\src\\Bundle\\CoreBundle\\Resources\\config\\doctrine' => 'Bundle\\CoreBundle\\Entity', 'D:\\xampp\\htdocs\\symfony\\JobBank\\src\\Bundle\\UserBundle\\Resources\\config\\doctrine' => 'Bundle\\UserBundle\\Entity', 'D:\\xampp\\htdocs\\symfony\\JobBank\\src\\Bundle\\EventBundle\\Resources\\config\\doctrine' => 'Bundle\\EventBundle\\Entity', 'D:\\xampp\\htdocs\\symfony\\JobBank\\src\\Bundle\\TaskBundle\\Resources\\config\\doctrine' => 'Bundle\\TaskBundle\\Entity', 'D:\\xampp\\htdocs\\symfony\\JobBank\\src\\Bundle\\ProjectBundle\\Resources\\config\\doctrine' => 'Bundle\\ProjectBundle\\Entity', 'D:\\xampp\\htdocs\\symfony\\JobBank\\src\\Bundle\\NotificationBundle\\Resources\\config\\doctrine' => 'Bundle\\NotificationBundle\\Entity', 'D:\\xampp\\htdocs\\symfony\\JobBank\\src\\Bundle\\CommentBundle\\Resources\\config\\doctrine' => 'Bundle\\CommentBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'D:\\xampp\\htdocs\\symfony\\JobBank\\src\\Bundle\\NewsBundle\\Entity')), 'Bundle\\NewsBundle\\Entity');
        ...
        $f->setProxyDir('D:/xampp/htdocs/symfony/JobBank/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'D:/xampp/htdocs/symfony/JobBank/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('D:/xampp/htdocs/symfony/JobBank/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/xampp/htdocs/symfony/JobBank/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'D:/xampp/htdocs/symfony/JobBank/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'D:/xampp/htdocs/symfony/JobBank/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/xampp/htdocs/symfony/JobBank/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('D:/xampp/htdocs/symfony/JobBank/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/xampp/htdocs/symfony/JobBank/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'D:/xampp/htdocs/symfony/JobBank/app', 'UTF-8');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'D:/xampp/htdocs/symfony/JobBank/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'D:/xampp/htdocs/symfony/JobBank/app', 'UTF-8'));
        ...
        $instance->addGlobal('app_version', '2.0.1');
        $instance->addGlobal('copy_right_year', 2015);
        $instance->addGlobal('client_name', 'Audinary');
        $instance->addGlobal('client_logo', 'http://localhost/symfony/JobBank/app/Resources/images/logo.png');
        $instance->addGlobal('client_icon', 'http://localhost/symfony/JobBank/app/Resources/images/icon.png');
        $instance->addGlobal('app_theme', 'http://localhost/symfony/JobBank/web/bundles/core/css/bootstrap-redy.css');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('D:\\xampp\\htdocs\\symfony\\JobBank\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('D:\\xampp\\htdocs\\symfony\\JobBank\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('D:\\xampp\\htdocs\\symfony\\JobBank\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('D:\\xampp\\htdocs\\symfony\\JobBank\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('D:\\xampp\\htdocs\\symfony\\JobBank\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('D:\\xampp\\htdocs\\symfony\\JobBank\\src\\Bundle\\NewsBundle/Resources/views', 'News');
        $instance->addPath('D:\\xampp\\htdocs\\symfony\\JobBank\\src\\Bundle\\CoreBundle/Resources/views', 'Core');
        $instance->addPath('D:\\xampp\\htdocs\\symfony\\JobBank\\src\\Bundle\\UserBundle/Resources/views', 'User');
        $instance->addPath('D:\\xampp\\htdocs\\symfony\\JobBank\\src\\Bundle\\EventBundle/Resources/views', 'Event');
        ...
        $instance->addPath('D:\\xampp\\htdocs\\symfony\\JobBank\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/xampp/htdocs/symfony/JobBank/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('D:/xampp/htdocs/symfony/JobBank/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/xampp/htdocs/symfony/JobBank/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'D:\\xampp\\htdocs\\symfony\\JobBank\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'D:/xampp/htdocs/symfony/JobBank/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/xampp/htdocs/symfony/JobBank/app/cache/dev',
            'kernel.logs_dir' => 'D:/xampp/htdocs/symfony/JobBank/app/logs',
            ...
            'client_name' => 'Audinary',
            'app_version' => '2.0.1',
            'app_root' => 'http://localhost/symfony/JobBank',
            'copy_right_year' => 2015,
            'client_icon' => 'icon.png',
            'client_favicon' => 'favicon.ico',
            'client_logo' => 'logo.png',
            'app_theme' => 'redy',
            'email_send' => 'moraspirit@gmail.com',
            'email_cc' => NULL,
            'email_bcc' => 'rshariffdeen@gmail.com',
            ...
            'debug.container.dump' => 'D:/xampp/htdocs/symfony/JobBank/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'D:/xampp/htdocs/symfony/JobBank/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'D:\\xampp\\htdocs\\symfony\\JobBank\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:D:/xampp/htdocs/symfony/JobBank/app/cache/dev/profiler',
            ...
            'router.resource' => 'D:/xampp/htdocs/symfony/JobBank/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/xampp/htdocs/symfony/JobBank/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/xampp/htdocs/symfony/JobBank/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/xampp/htdocs/symfony/JobBank/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'D:/xampp/htdocs/symfony/JobBank/app/../web',
            'assetic.write_to' => 'D:/xampp/htdocs/symfony/JobBank/app/../web',
            'assetic.variables' => array(

            ),
            'assetic.java.bin' => 'C:\\ProgramData\\Oracle\\Java\\javapath\\java.EXE',
            'assetic.node.bin' => 'D:\\Program Files (x86)\\nodejs\\node.EXE',
            ...
            'doctrine.orm.proxy_dir' => 'D:/xampp/htdocs/symfony/JobBank/app/cache/dev/doctrine/orm/Proxies',
