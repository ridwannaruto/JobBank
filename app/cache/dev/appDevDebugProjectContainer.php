...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('client_logo', 'http://localhost/volma/app/Resources/images/logo.png');
        $instance->addGlobal('client_icon', 'http://localhost/volma/app/Resources/images/icon.png');
        $instance->addGlobal('app_theme', '/volma/web/bundles/core/css/bootstrap-redy.css');
